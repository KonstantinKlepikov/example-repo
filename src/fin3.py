...
print(things[0:2])
print(" ")
## clear, pop, remove почему-то не работает
## del things[0] 'tuple' object doesn't support item deletion
...
## я не понимаю как сделать цикл для списка чтобы он работал
