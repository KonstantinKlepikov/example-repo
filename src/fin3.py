...
print(things)
print(" ")
# Переведите сырный элемент списка things в
# верхний регистр целиком и выведите список.
things.remove("salmonella")
print(things)
print(" ")

# Удалите из списка things заболевание,
# получите Нобелевскую премию и
# затем выведите список на экран.
print(things[0:2])
print(" ")
# things.remove("salmonella")

# Создайте список с элементами "Groucho" ,
# "Chico" и "Harpo" ; назовите его surprise.
...
# 'lower' for 'str' objects doesn't apply to a 'list' object
print(surprise[::-1])
print(" ")
